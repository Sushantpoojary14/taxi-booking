        ...
        <div class=" bg-gray-50 rounded-lg p-8 flex flex-col w-full m-auto ">
            ...
            <div class="flex flex-wrap -m-2 text-lg">
                <p>The AFTSPL group is a strategic, influential and credible leader in Fleet owner & Car Rental Solutions, with an extensive network across India.
                    ...
                    <p>A professional team with expertise in Design, Ergonomics, Customer Processes & Functionality requirements result in the State-of-the-Art Consoles that lead to avant-garde solutions.
                        At AFTPSL, we guarantee our customers absolute peace of mind, Assurance, reliability, Secure environments, and commitment to quality.</p>

                    <h3 class="font-bold mt-3">Address</h3>
                    <p>M-1, Best Colony, Ghatkopar East, Mumbai, Maharashtra 400075
