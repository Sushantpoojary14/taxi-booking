    ...
    <section class="text-indigo-900 body-font font-bold ">
        <div class="container px-5 py-10 mx-auto flex flex-wrap items-center">
            ...
            <div class="lg:w-2/6 md:w-1/2 bg-gray-100 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
                ...
                <div class="relative mb-4">
                    <button
                        class=" w-full text-white bg-indigo-800 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg transition ease-in-out delay-150 bg-blue-500 hover:bg-indigo-500 duration-300"
...
@section('script')
    ...
    <script>
        ...
        // let select = document.getElementById('c_permit');
        ...
        async function index(para) {
            ...
            await fetch(url, {
                ...
                .then(data => {
                    ...
                    //         option.selected = true;
                    //     }
                    //     option.innerHTML = element.permit_place;
