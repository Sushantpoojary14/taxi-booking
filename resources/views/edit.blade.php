                    ...
                    <section class="text-gray-600 body-font">
                        <div class="container px-5 py-0 mx-auto ">
                            <div class="flex flex-col text-center  mb-6 ">
                                <h1 class="sm:text-4xl text-3xl font-medium title-font mb-2 dark:text-white ">Edit Profile
                                </h1>

                            </div>
                            <div class="lg:w-11/12 w-full mx-auto font-medium text-xl ">
                                <form action="{{ route('profile.update') }}" method="post" class="m-0 p-0">
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <select id="car_type" name="car_type"
                                                        class="w-full block bg-white border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm p-2">
                                                        @foreach ($data->category as $item)
                                                            <option value="{{ $item->type }}">Select</option>
                                                        @endforeach
                                                        @foreach ($category as $item)
                                                            <option
                                                                class="bg-white border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm p-2"
                                                                value="{{ $item->type }}">
