                                ...
                                <form action="{{ route('admin.print') }}" method="post" >
                                    ...
                                    <div class="lg:w-11/12 md:w-2/3 mx-auto  ">
                                        ...
                                        <div class="flex flex-row flex-wrap -m-2">
                                            <div class="p-2 w-2/4">
                                                <div class="relative">
                                                    ...
                                                    <x-text-input type="text" id="fullname" name="fullname"
                                                        {{-- {{ $name = $item->firstname}} --}} class=""
                                                        value="{{ $detail == null ? '' : $detail['fullname'] }}" />
                                            ...
                                            <div class="p-2 w-2/4">
                                                <div class="relative">
                                                    <label for="location" class="leading-7  text-gray-400 my-2">Destination
                                                    </label>
                                            ...
                                            <div class="p-2 w-2/4">
                                                <div class="relative">
                                                    <label for="fair" class="leading-7  text-gray-400 my-2">Fair
                                                        Charge</label>
                                            ...
                                            <div class="p-2 w-2/4">
                                                <div class="relative">
                                                    <label for="night_fair" class="leading-7  text-gray-400 my-2">Night
                                                        Charge</label>

                                                    <x-text-input type="text" id="night_fair" name="night_fair"
                                                        class=""
                                                        value="{{ $detail == null ? '' : $detail['night_fair'] }}" />
                                            ...
                                            <div class="p-2 w-2/4">
                                                <div class="relative">
                                                    <label for="payment" class="leading-7  dark:text-gray-400 my-2">Mode of
                                                        Payment: </label>
                                                    <select id="payment" name="payment"
                                                        ...
                                                        <option value="cash"
                                                            ...
                                                            {{ $detail == null ? '' : ($detail['payment'] == 'cash' ? 'selected' : '') }}>
                                                            Cash
                                                        ...
                                                        <option value="upi"
                                                            class="bg-white border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm p-1"
                                                            {{ $detail == null ? '' : ($detail['payment'] == 'upi' ? 'selected' : '') }}>
                                                            UPI
                                                        ...
                                                        <option value="card"
                                                            class="bg-white border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm p-1"
                                                            {{ $detail == null ? '' : ($detail['payment'] == 'card' ? 'selected' : '') }}>
                                                            Card
                                            ...
                                            {{-- <div class="p-2 w-2/4">
                                                <div class="relative">
                                                    ...
                                                    <x-text-input type="text" id="parking_charges" name="parking_charges"
                                                        class=""
                                                        value="{{ $detail == null ? '' : $detail['parking_charges'] }}" />
